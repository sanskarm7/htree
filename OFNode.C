...
void OFNode::ConstructSubtree(OFNode *subtreeNode, int splitnode, int option, DataNode **deleted_child_nodes, int *num_deleted_child_nodes, ReinsertItem *reinsertion_list, int *num_points_in_list)
{
  int target, leftchild, rightchild;
  int rootptr;
  int status;
...
int OFNode::EliminateEmptyNodes(DataNode **deleted_child_nodes, int num_deleted_child_nodes)
{
  unsigned int parent, grandparent, parent2, parent3, sibling, rightchild, leftchild;
  int i, jj, kk;
  DataNode *datanode;
